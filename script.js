...
myFavoriteFood = "pickles";

if (myFavoriteFood === "tacos") {
    console.log("they are delicious")
} else if (myFavoriteFood === "pizza") {
    console.log("gimme a slice")
} else {
    console.log("eww gross throw it away")
}
...
//you can also put in an 'or' statement
...
var weatherData = {
  ...
  //can't figure this one out to save my life...
